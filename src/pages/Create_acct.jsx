    ...
    return (
        <div>
            ...
            <div id="create-acct-form">
                ...
                <div id="password">
                    <input type="Password" placeholder="Password (8 or more characters)"></input>
                </div>
                ...
                <div id="acknowledgement">
                    ...
                    <label><input type="checkbox"/></label>
                    <p>I acknowledge and agree to MakeWeWork terms of use, user agreement, and privacy policies.</p>

                </div>
                
                <button type="submit">Sign Up</button>

                <p>Looking for work? <a href="/">Join as a talent.</a></p>
